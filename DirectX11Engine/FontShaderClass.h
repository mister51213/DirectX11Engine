...
public:
	...
	bool Render(ID3D11DeviceContext* deviceContext, int indexCount, MatrixBufferType transforms,/* XMMATRIX worldMatrix, XMMATRIX viewMatrix,
...
private:
	...
	bool SetShaderParameters(ID3D11DeviceContext*, MatrixBufferType transforms, /*XMMATRIX, XMMATRIX, XMMATRIX, */ID3D11ShaderResourceView*, vector<Microsoft::WRL::ComPtr <ID3D11ShaderResourceView>>& texViews, XMFLOAT4);
