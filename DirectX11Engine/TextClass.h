...
public:
	...
	void Shutdown();
	void Render(ID3D11DeviceContext*, FontShaderClass* pFontShader, XMMATRIX, XMMATRIX, XMMATRIX, ID3D11ShaderResourceView*);
...
private:
	...
	void RenderSentence(ID3D11DeviceContext*, FontShaderClass* pFontShader, XMMATRIX, XMMATRIX, XMMATRIX, ID3D11ShaderResourceView*);
