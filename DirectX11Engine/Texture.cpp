...
bool TextureClass::InitializeArrayTga(ID3D11Device* device, ID3D11DeviceContext* deviceContext, char* filename1, char* filename2, char* filename3, char* filename4, char* filename5, char* filename6)
{
	InitializeTexTga(device, deviceContext, filename1, &_targaData1, &_texture1, &_textureViews[0]);
	InitializeTexTga(device, deviceContext, filename2, &_targaData2, &_texture2, &_textureViews[1]);
	InitializeTexTga(device, deviceContext, filename3, &_targaData3, &_texture3, &_textureViews[2]);
	InitializeTexTga(device, deviceContext, filename4, &_targaData4, &_texture4, &_textureViews[3]);
	InitializeTexTga(device, deviceContext, filename5, &_targaData5, &_texture5, &_textureViews[4]);
	InitializeTexTga(device, deviceContext, filename6, &_targaData6, &_texture6, &_textureViews[5]);
	...
	//_targaData6 = LoadTarga(filename6, height, width, _targaData6);
	//if (!_targaData6)
	//{
	//	return false;
	//}
