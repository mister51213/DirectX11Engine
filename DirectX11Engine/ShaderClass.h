...
protected:
	...
	bool CompileShaders(ID3D11Device * device, HWND hwnd, string vsFilename,string psFilename,/*char* vsFilename, char* psFilename,*/ char* vsDesc, char* psDesc, ID3D10Blob* errorMessage = nullptr);
